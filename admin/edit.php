                            ...
                            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text" value="<?= $array['name'] ?>" class="span11" placeholder="Product name" name="name" required /> *
                                    </div>
                                </div>
                                <div class="control-group">
                                        ...
                                        <select name="manu_id" id="subcate">
                                            <?php
                                             foreach ($manufacture->getAllManufactures() as $value) { 
                                                ...
                                                ?>
                                                <option selected value="<?= $value['manu_id'] ?>"><?= $value['manu_name'] ?></option>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select name="type_id" id="subcate">
                                            <?php foreach ($protype->getAllProtype() as $value) {
                                                ...
                                                ?>
                                                <option selected value="<?= $value['type_id'] ?>"><?= $value['type_name'] ?></option>
                                            <?php }else{?>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <img style="width:100px;height:100px" src="<?= "../images/".$array['pro_image'] ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Chi tiết</label>
                                        <div class="controls">
                                            <textarea class="span11" required placeholder="Description" name="description"><?= $array['description'] ?></textarea>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Giá:</label>
                                            <div class="controls">
                                                <input type="number" value="<?= $array['price'] ?>" class="span11" placeholder="price" name="price" required /> *
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Nổi bật:</label>
                                            <div class="controls">
                                                <input type="number" value="<?= $array['feature'] ?>" class="span11" name="feature" min="0" max="1" required /> *
                                            </div>
                                        </div>
                                        <div class="form-actions">
                                            <button type="submit" name="submitEditProduct" class="btn btn-success">Cập nhật</button>
                                        </div>
                                    </div>
                             </form><?php }}?>
                             <!-- Edit manu !-->
                            ...
                            <form action="" class="form-horizontal" enctype="multipart/form-data" method="post">    
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text" value="<?= $value['manu_name'] ?>" class="span11" placeholder="Manu name" name="name" required /> *
                            ...
                            <form action="" class="form-horizontal" enctype="multipart/form-data" method="post">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text" value="<?= $value['type_name'] ?>" class="span11" placeholder="Protype name" name="name" required /> *
